...
class PlayerControls {
  ...
  GetContentTitle() {
    if(this.player.playerOptions.title !== false && this.player.playerOptions.controls !== EluvioPlayerParameters.controls.DEFAULT) {
      const collectionInfo = this.GetCollectionInfo();
  ...
  SetPlaybackRate(index) {
    this.player.video.playbackRate = this.GetPlaybackRates().options[index].rate;
