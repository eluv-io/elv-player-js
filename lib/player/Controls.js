...
class PlayerControls {
    ...
    if(this.player.playerOptions.title !== false) {
      ...
      if(collectionInfo && collectionInfo.active) {
        return {
          ...
          posterImage: (collectionInfo.active.posterImage && collectionInfo.active.posterImage.url) || "",
  ...
  /**
   * Register a listener to be called when player state changes. State includes play/pause state, manual quality/audio/subtitle/playback speed changes, track changes
   *
   * @methodGroup Events
