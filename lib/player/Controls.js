...
class PlayerControls {
  static ID_SEEKBAR = "seekbar";
  static ID_INFO_BUTTON = "info-button";
  static ID_PREV_TRACK = "prev_track";
  static ID_REWIND = "rewind";
  static ID_PLAYPAUSE = "playpause";
  static ID_FASTFORWARD = "fastforward";
  static ID_NEXT_TRACK = "next_track";
  static ID_CONTENT_VERIFICATION_MENU = "content-verification-menu";
  static ID_SETTINGS_MENU = "settings-menu";
  ...
  constructor({player}) {
    ...
    this.controlIdPrefix = Math.random().toString(36).slice(2);
  }

  GetControlId(id){
    return `${this.controlIdPrefix}_${id}`;
  }
