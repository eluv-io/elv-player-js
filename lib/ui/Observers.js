  ...
  switch (event.key) {
    case "ArrowUp":
      if(player.controls.IsMenuVisible()) {
        ...
        document.getElementById(player.controls.GetControlId(PlayerControls.ID_SEEKBAR))?.focus();
        return true;
      }
      return false;
    case "ArrowDown":
      if(player.controls.IsMenuVisible()) {
        ...
        document.getElementById(player.controls.GetControlId(PlayerControls.ID_PLAYPAUSE))?.focus();
        return true;
      }
      return false;
    case "ArrowLeft":
